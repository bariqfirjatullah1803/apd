...
class M_perjadin_ld extends CI_Model
{
    ...
    // ==========
        ...
        public function getRecapFromOneSection($idBag)
        {
            ...
            where assoc.idBagian = '".$idBag."' and gi.idKategori = 'ld'";
        ...
        public function downloadRincian($stamp)
        {
            $filename = 'docs/RINCIAN-' . $stamp . '.xls';
        ...
        public function insertDataAndGenerate($idBag)
        {
            ...
            // ANCHOR @ Insert into Database @
                ...
                // {Insert into Database - recap_money_transport_details} @ TESTING REQUIRED @
                    $moneyTransInformation = [
                        ...
                        // "nominalTransportTaksi" =>$nominalTransportTaksi,
            ...
            // ANCHOR @ Generate Documents @
                ...
                // {Generate Kwitansi} @ Generate Kwitansi @
                    ...
                    "Biaya Perjalanan Dinas Luar Daerah dalam rangka " . $acara ." yang dilaksanakan pada hari " . $namaHari .
                ...
                // {Generate Tanda Terima} @ Generate Tanda Terima @
                    ...
                    for ($i=$initialIndex; $i <=$limit;) {
                        ...
                        // Removing any text in these 2 column
                    ...
                    // {BBM dan ETOLL u/ Pimpinan Rombongan}
                ...
                // {Generate Rincian}
                    ...
                    $spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('assets/template/TMP_RINCIAN_LD.xlsx');
                    ...
                    // {Pimpinan Perjadin}
                        ...
                        // {Biaya BBM}
                        $worksheet->getCell('F27')->setValue($nominalBBM);
                        $worksheet->getCell('K27')->setValue($durasiTanpaHari);

                        // {Biaya Transport}
                        $worksheet->getCell('F28')->setValue($nominalTransportSewaKendaraan);

                        // {Biaya EToll}
                        $worksheet->getCell('F29')->setValue($nominalEToll);
                        ...
                        if($nominalPenginapanPerHari>0){
                            ...
                            $worksheet->getCell('F30')->setValue(0);
                    ...
                    // {Pengikut Perjadin}
                        ...
                        if ($nominalPenginapan>0) {
                            // {Biaya Penginapan}
                            $worksheet->getCell('F36')->setValue($nominalPenginapanPerHari);
                            $worksheet->getCell('H36')->setValue(($jmlAll-1));
                            $worksheet->getCell('K36')->setValue($durasiTanpaHari);
                        }else{
                            // {Biaya Penginapan}
                            $worksheet->getCell('F36')->setValue(0);
                            $worksheet->getCell('H36')->setValue(0);
                            $worksheet->getCell('K36')->setValue(0);
                        }
                    // 
