...
<head>
    ...
    <meta content="SIMPERDINSETDA" name="description" />
    <meta content="Ari Mahardika Ahmad Nafis" name="author" />
    <!-- App favicon -->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <!-- <h7 class="text mb-2 mt-4">Akan dilakukan maintenance pada <br> 05/09/2022 12:00 WIB s/d 12/09/2022 12:00 WIB <br></h6> -->
                                        <!-- <h7 class="text mb-2 mt-4">Selama maintenance SIMPERDINSETDA tidak bisa digunakan</h6> -->
                                        <!-- <p class="text-muted"> Masukkan Username dan Password Anda.</p> -->
                                    </div>

                                    <!-- Action where login button will go -->
                                    <form class="form-horizontal mt-4 pt-2 login-form" method="POST" action="<?= base_url(); ?>C_login/createSession">
                        ...
                        <div class="mt-5 text-center text-white"><?= PATCH ?> <br>
                            <!-- <p>Don't have an account ?<a href="auth-register.html" class="fw-bold text-white"> Register</a> </p> -->
                            <p>© <script>
                                    document.write(new Date().getFullYear())
                                </script> Ari Mahardika. Crafted with <i class="mdi mdi-heart text-danger"></i></p>
                        </div>
                    </div>
                </div>
