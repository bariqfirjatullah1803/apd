        ...
        <div class="card">
            <div class="card-body">
                ...
                <!-- { GENERAL } -->
                    ...
                    <!-- {1. perjadin-categories-container} -->
                        <div class="row mb-3">
                            <label for="Nomor Surat" class="col-sm-3 col-form-label">perjadin-categories-container</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="perjadin-categories-container" 
                                id="perjadin-categories-container" placeholder="" row readonly>
                            </div>
                        </div>
                    <!--  -->
                    <!-- {2. status-titipan-input} -->
                    ...
                    <!-- {9. lebih-dari-8-jam-input}  -->
                        <div class="row mb-3" style="">
                            <label for="example-text-input" class="col-sm-3 col-form-label">Lebih dari 8 jam? *</label>
                            <div class="col-sm-3">
                                <select class="select2 form-control select2-multiple lebih-8-jam-input" multiple="multiple" name="lebih-8-jam-input" placeholder="test" id="lebih-8-jam-input" required>
                                    <option value="1">YA</option>
                                    <option value="0">TIDAK</option>
                                </select>
                            </div>
                    ...
                    <!-- qr : stored inside {14-15. bbm-container} -->
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-3 col-form-label">BBM (At Cost) * </label>
                            <div class="col-sm-3"><input class="form-control" type="number" placeholder="" id="bbm-input" name="bbm-input" required></div>
                            <label for="example-text-input" class="col-sm-3 col-form-label">Batasan Tertinggi</label>
                            <div class="col-sm-3"><input class="form-control" readonly type="number" placeholder="" id="bbm-max" name="bbm-max"></div>
                        </div>
                    <!--  -->

                    <!-- qr : stored inside {16. biaya-tol-berangkat-input} -->
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-3 col-form-label">Biaya Tol Berangkat (At Cost) * </label>
                            <div class="col-sm-3"><input class="form-control" type="number" placeholder="" id="biaya-tol-berangkat-input" name="biaya-tol-berangkat-input" required></div>
                        </div>
                    <!--  -->
                    <!-- qr : stored inside {17. biaya-tol-pulang-input} -->
                    <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-3 col-form-label">Biaya Tol Pulang (At Cost) * </label>
                            <div class="col-sm-3"><input class="form-control" type="number" placeholder="" id="biaya-tol-pulang-input" name="biaya-tol-pulang-input" required></div>
                        </div>
                    <!--  -->

                    <!-- qr : stored inside {18. penginapan-container} -->
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-3 col-form-label">Penginapan (At Cost) * </label>
                            <div class="col-sm-3"><input class="form-control" type="number" placeholder="" id="penginapan-input" name="penginapan-input" required></div>
                        </div>
                    <!--  -->

                    <!-- qr : {19. transportasi-lain-berangkat-input}-->
                            <div id="multiselect-ttd" class="row mb-3">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Alat Transportasi yang Digunakan (Berangkat) * </label>
                                <div class="col-sm-3">
                                    <select id="transportasi-lain-berangkat-input" class="select2 form-control select2-multiple transportasi-lain-berangkat-input" multiple="multiple" onchange="onChangeBiayaTransport()" required>
                    ...
                    <!-- qr : {20. transportasi-lain-pulang-input}-->
                            <div id="multiselect-ttd" class="row mb-3">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Alat Transportasi yang Digunakan (Pulang) * </label>
                                <div class="col-sm-3">
                                    <select id="transportasi-lain-pulang-input" class="select2 form-control select2-multiple transportasi-lain-pulang-input" multiple="multiple" onchange="onChangeBiayaTransport()" required>
                                        <option>Pesawat</option>
                                        <option>Kapal</option>
                                        <option>Kereta</option>
                                        <option>Bus</option>
                    ...
                    <!-- qr : 
                    input id -> {21. penandatangan-input}
