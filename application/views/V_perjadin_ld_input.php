<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Form Perjalanan Dinas Luar Daerah</h4>
                <p class="card-title-desc">Isi data-data dibawah untuk membuat dokumen Perjalanan Dinas Luar Daerah</p>

                <form action="<?= base_url(); ?>C_perjadin_ld/tambahData" method="post" autocomplete="off">
                <!-- ================== -->
                <!-- ANCHOR VIEW        -->
                <!-- ================== -->
                    ...
                    <!-- qr : stored inside {kota-container} -->
                        <div id="kota-tujuan" style="display:" class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <!-- @ FIX THIS @ -->
                                    <?php foreach ($tujuan_ld as $tujuan_ld) : ?>
                                        <option><?= $tujuan_ld['namaTujuan']; ?></option>
                                    <?php endforeach; ?>
                    ...
                    <!-- qr : stored inside {acara-container} -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9"><input class="form-control" type="text" placeholder="" id="acara-container" name="acara-container"></div>
                        </div>
                    <!--  -->
                    ...
                    <!-- qr : stored inside {biaya-tol-container} -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3"><input class="form-control" type="number" placeholder="" id="biaya-tol-input" name="biaya-tol-input" required></div>
                        </div>
                    <!--  -->
                ...
                <!-- ================== -->
                    ...
                    <div class="row mb-3" style="display:none">
                        ...
                        <!-- @ Dasar Surat @ {Get from input above [dasar-surat-container] } -->
                        ...
                        <!-- @ Money Calculations @ -->
                            <label class="col-sm-12 col-form-label alert alert-info mt-3"> Money Calculations </label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <label for="example-text-input" class="col-sm-2 col-form-label">nominal-ut-all-terbilang-container </label>
                    ...
                    <script>
                        ...
                        // =========================================================================================
                            function calculateUH(){
                                ...
                                gebid('nominal-uh-container').value = "410000";

                                gebid('nominal-uh-all-container').value = parseInt(gebid('nominal-uh-container').value) * document.getElementById('durasi-tanpa-hari-container').value;
                            ...
                            function calculateUT(){
                                ...
                                console.log('nominalutall '+gebid('nominal-ut-all-container').value);
                                console.log('nominalut '+gebid('nominal-ut-container').value);
                                console.log('durasitanpahari '+gebid('durasi-tanpa-hari-container').value);
