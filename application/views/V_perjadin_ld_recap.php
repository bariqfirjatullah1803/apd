    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <table style="display: none" id="datatable-buttons" class="table nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <?php foreach ($dataRecap as $recapKolom) : ?>
                                    <tr>
                                        ...
                                        <td id="tooltip-container1">
                                            <a href="<?= base_url() ?>C_perjadin_ld/hapus/<?= $recapKolom['idSubmit']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" class=" text-danger" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="mdi mdi-trash-can font-size-18"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
