                            ...
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <div class="text-center">
                                        <!-- <img src="assets/images/logo-renkeu-land.png" height="20" alt="logo"> -->

                                    </div>

                                    <div class="text-center p-3">

                                        <h1 class="error-page mt-3"><span>404!</span></h1>
                                        ...
                                        <a class="btn btn-primary waves-effect waves-light" href="dashboard"><i class="mdi mdi-home"></i> Back to Dashboard</a>
                                    </div>
